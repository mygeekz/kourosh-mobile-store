  ...
  return (
    <div
      ...
      className={[
        ...
        'shadow-[0_22px_50px_-38px_rgba(15,23,42,0.22)] transition-[border-color,box-shadow,outline-color] duration-200',
        editable
    ...
    >
      ...
      <div
        data-ui-dashboard-widget-content="true"
        className={editable
          ? 'dashboard-widget-content dashboard-widget-content--editable h-[calc(100%-52px)]'
          : 'dashboard-widget-content h-full'}
      >
        {children(content)}
      </div>
    </div>
