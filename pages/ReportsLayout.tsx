...
const REPORT_META: ReportMeta[] = [
  {
    path: "/reports",
    title: "مرکز گزارش‌ها",
    description: "نقشه گزارش‌های رسمی و تحلیل‌ها",
  },
  {
    path: "/reports/sales-summary",
    title: "گزارش فروش و سود",
    description: "روند فروش، پرفروش‌ها و سود ناخالص در بازه",
  },
  {
    path: "/reports/sales",
    title: "گزارش فروش و سود",
    description: "مسیر سریع گزارش فروش و سود",
  },
  {
    path: "/reports/product-sales",
    title: "فروش غیرگوشی",
    description: "جمع و جزئیات فروش لوازم و خدمات با خروجی",
  },
  {
    path: "/reports/followups",
    title: "پیگیری‌ها",
    description: "لیست پیگیری‌ها و وضعیت انجام",
  },
  {
    path: "/reports/collection-center",
    title: "مرکز پیگیری وصول",
    description: "اولویت‌های روزانه وصول، اقدام سریع و تاریخچه پیگیری",
  },
  {
    path: "/reports/collection-followup",
    title: "مرکز پیگیری وصول",
    description: "مسیر سریع مرکز پیگیری وصول",
  },
  {
    path: "/reports/debtors",
    title: "گزارش بدهکاران",
    description: "لیست بدهکاران مشتری با مرتب‌سازی و جستجو",
  },
  {
    path: "/reports/creditors",
    title: "گزارش بستانکاران",
    description: "لیست بستانکاران تامین‌کننده/همکار",
  },
  {
    path: "/reports/top-customers",
    title: "مشتریان برتر",
    description: "رتبه‌بندی مشتریان پرفروش در بازه انتخابی",
  },
  {
    path: "/reports/top-suppliers",
    title: "تامین‌کنندگان برتر",
    description: "رتبه‌بندی تأمین‌کنندگان بر اساس گردش و ارزش خرید",
  },
  {
    path: "/reports/mobile-sales-analytics",
    title: "تحلیل گوشی نقد و اقساط",
    description: "مرکز سود، ریسک وصول، قیمت خرید روز و اصل پول شرکا",
  },
  {
    path: "/reports/smart-insights",
    title: "دستیار هوشمند مدیریت",
    description:
      "بینش‌های قابل اقدام، وضعیت یادگیری، تشخیص ریسک و پیشنهادهای هوشمند",
  },
  {
    path: "/reports/phone-sales",
    title: "فروش موبایل (نقدی)",
    description: "سود هر فروش موبایل، IMEI، مشتری و تاریخ",
  },
  {
    path: "/reports/phone-installment-sales",
    title: "فروش اقساطی موبایل",
    description: "سود فروش‌های اقساطی موبایل در بازه",
  },
  {
    path: "/reports/periodic-comparison",
    title: "مقایسه‌ای فروش",
    description: "مقایسه دوره انتخابی با دوره قبل/سال قبل",
  },
  {
    path: "/reports/financial-overview",
    title: "نمای کلی مالی",
    description: "شاخص‌های مالی، مانده‌ها و گردش نقدی",
  },
  {
    path: "/reports/financial-audit",
    title: "ممیزی اختلاف گزارش‌ها",
    description: "کنترل اختلاف فروش، پرداخت، سود و موجودی",
  },
  {
    path: "/reports/realized-profit",
    title: "سود تحقق‌یافته",
    description: "سود شناسایی‌شده بر اساس وصول واقعی و COGS نسبتی",
  },
  {
    path: "/reports/analytics",
    title: "داشبورد تحلیلی",
    description: "روندها، مقایسه ماه‌ها و تحلیل محصولات",
  },
  {
    path: "/reports/product-profit-real",
    title: "سود واقعی هر محصول",
    description: "سود/زیان واقعی (FIFO) و سهم از درآمد",
  },
  {
    path: "/reports/installments-calendar",
    title: "تقویم اقساط و چک‌ها",
    description: "نمایش سررسیدها در بازه انتخابی",
  },
  { path: "/reports/rfm", title: "RFM", description: "تحلیل وفاداری مشتریان" },
  {
    path: "/reports/cohort",
    title: "تحلیل بازگشت مشتری",
    description: "تحلیل بازگشت مشتریان در گروه‌های زمانی",
  },
  {
    path: "/reports/inventory-turnover",
    title: "گردش موجودی",
    description: "گردش موجودی و میانگین روزهای ماندگاری کالا",
  },
  {
    path: "/reports/dead-stock",
    title: "کالاهای راکد",
    description: "کالاهای بدون حرکت و خواب سرمایه",
  },
  {
    path: "/reports/abc",
    title: "تحلیل ABC موجودی",
    description: "طبقه‌بندی کالاها بر اساس ارزش و گردش فروش",
  },
  {
    path: "/reports/aging-receivables",
    title: "سن بدهی و ریسک وصول",
    description: "اولویت‌بندی بدهی مشتریان بر اساس مدت‌زمان عقب‌افتادگی",
  },
  {
    path: "/reports/cashflow",
    title: "جریان نقدی",
    description: "ورودی و خروجی نقدی واقعی فروشگاه",
  },
  {
    path: "/reports/analysis",
    title: "تحلیل پیشرفته",
    description: "سودآوری، سلامت موجودی و پیشنهاد خرید",
  },
  {
    path: "/reports/analysis/profitability",
    title: "تحلیل سودآوری",
    description: "سودآوری و سهم سود در بازه",
  },
  {
    path: "/reports/analysis/inventory",
    title: "تحلیل موجودی",
    description: "تحلیل موجودی و گردش کالا",
  },
  {
    path: "/reports/analysis/suggestions",
    title: "پیشنهاد خرید هوشمند",
    description: "پیشنهاد خرید بر اساس روند فروش",
  },
];
...
const ReportsLayout: React.FC = () => {
  ...
  const commandItems = useMemo<ReportCommandItem[]>(() => {
    const reportItems: ReportCommandItem[] = REPORT_META.filter(
