  ...
  return (
    ...
    >
      ...
      <DialogShell
        ...
        ariaLabel="فضای کاری گزارش‌ها"
        overlayClassName="reports-workspace reports-workspace--drawer reports-workspace--dialog-shell app-modal-backdrop !items-stretch !justify-end !p-0"
        panelClassName="reports-workspace__drawer reports-workspace__drawer--dialog-shell"
        closeOnBackdrop
      >
