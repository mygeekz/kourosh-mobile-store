import { Table, DialogShell, SelectField, TextField } from '@/components/ui';
      ...
      <section className="messaging-center-v2__hero">
        ...
        <div className="messaging-center-v2__hero-tools">
          ...
          <div className="messaging-center-v2__meta">
            <span><i className="fa-solid fa-database" /> داده ثبت‌شده فروشگاه</span>
          ...
          <>
              ...
              <div className="outbox-detail-card outbox-detail-modal-landscape outbox-detail-modal-outbox">
                ...
                <div className="outbox-detail-actions">
                  ...
                  {selectedOutbox.channel === 'telegram' ? <button type="button" className={ghostButton} disabled={busyId === selectedOutbox.id} onClick={() => void sendCheck(selectedOutbox)}><i className="fa-regular fa-circle-check" /> بررسی ارسال تلگرام</button> : null}
                </div>
              </div>
          </>
        );
