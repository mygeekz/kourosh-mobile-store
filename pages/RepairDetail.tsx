...
export default function RepairDetail(): React.ReactElement | null {
  ...
  return (
    <div className="detail-page-shell products-services-redesign-v1 repairs-redesign-v1 repair-detail-redesign-v1 repair-workflow-foundation space-y-6 px-2 sm:px-4" dir="rtl" data-ui-repair-page="detail" data-ui-repair-scope="detail">
        ...
        <div data-ui-repair-surface="edit-banner" className="rounded-2xl border border-amber-200 bg-gradient-to-r from-amber-50 via-orange-50 to-rose-50 p-4 shadow-sm dark:border-amber-500/30 dark:from-amber-500/10 dark:via-orange-500/10 dark:to-rose-500/10 dark:bg-none">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div className="flex items-start gap-3">
              <IconGlyph size="lg" tone="warning" className="h-11 w-11" aria-hidden="true">
          ...
          <div className="space-y-4" data-ui-repair-modal="add-part">
            ...
            <div className="space-y-2">
              ...
              <SearchableSelectField
                ...
                onValueChange={(value) => setSelectedPart((current) => ({ ...current, productId: value ? String(value) : '' }))}
