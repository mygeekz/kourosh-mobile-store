...
import {
  ActionLink, Button, DataTableShell, PageKit, PanelCard, SelectField, SurfaceHeader, type SurfaceTone } from '@/components/ui';
        ...
        <div className="space-y-4" dir="rtl">
          <section aria-label="خلاصه حسابرسی مالی">
            <SurfaceHeader
              ...
              subtitle="امتیاز و موارد این صفحه مستقیماً از نتایج ممیزی ثبت‌شده خوانده می‌شوند."
              icon={<i className="fa-solid fa-shield-halved" />}
          ...
          >
            <Table className="report-table ux-data-table min-w-[980px] w-full" layout="managed" data-ui-bidi-scope="rtl-table">
              <thead>
                <tr>
