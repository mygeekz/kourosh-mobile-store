      ...
      {activeTab === 'risk' && (
        <section className="rounded-[30px] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-950">
          ...
          <div className="mt-4 grid gap-3">
            ...
            )) : <EmptyState text="پرونده ریسک‌دار برای این بازه پیدا نشد." />}
          </div>
        </section>
      )}
        ...
        <section className="space-y-4">
          ...
          <section className="rounded-[30px] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-950">
            ...
            <div className="mt-4 overflow-x-auto">
              ...
              ) : <EmptyState text="برای این بازه/جستجو سهم گوشی شرکا پیدا نشد." />}
            </div>
          </section>
        </section>
      )}
