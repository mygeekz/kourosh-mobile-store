...
import {
  createColumnHelper, flexRender, getCoreRowModel, getFilteredRowModel, getPaginationRowModel, getSortedRowModel, SortingState, useReactTable, } from '@tanstack/react-table';
            ...
            {isLoading ? (
              ...
              <>
                <div className="hidden lg:block">
                  <Table className="report-table ux-data-table w-full table-fixed" layout="managed" data-ui-bidi-scope="rtl-table">
                    <colgroup>
                      <col className="w-[24%]" />
                      <col className="w-[10%]" />
                      <col className="w-[17%]" />
