...
import {
  createColumnHelper, useReactTable, getCoreRowModel, getFilteredRowModel, getPaginationRowModel, flexRender, } from '@tanstack/react-table';
...
import ReportControlDock, {
  ReportControlDateSection, ReportControlFooter, ReportControlStatus, } from '../../components/reports/ReportControlDock';
        ...
        {reportData && (
          <div className="space-y-4">
            ...
            {reportData.topSellingItems && (
              ...
              >
                <Table className="sales-exec-table report-table ux-data-table" layout="managed" data-ui-bidi-scope="rtl-table">
