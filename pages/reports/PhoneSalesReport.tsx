import { Table, ActionLink, AppSearchField, Button, DataTableShell, EmptyState, PanelCard, SelectField, Surface, SurfaceHeader } from '@/components/ui';
        ...
        {isLoading ? (
          ...
          <>
            <div className="hidden xl:block">
              <Table className="report-table ux-data-table" layout="managed" data-ui-bidi-scope="rtl-table">
                <thead>
                  <tr>
                    <th>تاریخ و سند</th>
                    <th>گوشی</th>
