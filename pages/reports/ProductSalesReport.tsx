import { Table, AppSearchField, Button, DataTableShell, Drawer, EmptyState, IconGlyph, SelectField } from '@/components/ui';
...
function ReportSideDrawer({
  ...
  return (
    <Drawer
      ...
      size={size}
      hideHeader
      overlayClassName={`report-side-drawer-backdrop report-side-drawer-backdrop--${tone}`}
        ...
        {totalFilteredRows > 0 && (
          ...
          >
            <div className="overflow-auto">
              <Table className="product-sales-compact-table report-table ux-data-table" layout="managed" data-ui-bidi-scope="rtl-table">
                <colgroup>
