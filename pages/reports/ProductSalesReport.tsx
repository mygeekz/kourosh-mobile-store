...
const numberFa = (n: number, options?: Intl.NumberFormatOptions) =>
  (Number(n) || 0).toLocaleString("fa-IR", options);
const percentFa = (n: number) =>
  `${numberFa(n, { maximumFractionDigits: 2 })}٪`;
...
const getCollectionRiskSummaryText = (risk: CollectionRiskSummary) => {
  const parts = [
    risk.counts.critical
      ? risk.counts.critical.toLocaleString("fa-IR") + " بحرانی"
      : "",
    risk.counts.urgent
      ? risk.counts.urgent.toLocaleString("fa-IR") + " فوری"
      : "",
    risk.counts.followup
      ? risk.counts.followup.toLocaleString("fa-IR") + " نیازمند پیگیری"
      : "",
...
export default function ProductSalesReport() {
  ...
  return (
    <div dir="rtl">
      ...
      >
        <section
          className="product-sales-control-panel"
          aria-label="فیلترهای فروش کالا و خدمات"
        >
          ...
          <div className="product-sales-control-panel__row product-sales-control-panel__row--modes">
            <div
              className="product-sales-segment"
              aria-label="فیلتر حسابرسی تخفیف"
            >
              <span className="product-sales-segment__label">
                حسابرسی تخفیف
              </span>
            ...
            <div
              className="product-sales-segment product-sales-segment--profit"
              aria-label="نمای سود"
            >
          ...
          <div className="product-sales-metrics-grid product-sales-metrics-grid--primary">
            <article className="product-sales-metric-card">
              ...
              <div className="product-sales-metric-card__body">
                ...
                <em>
                  درصد وصول:{" "}
                  {cashCollectionRate.toLocaleString("fa-IR", {
            ...
            <article className="product-sales-metric-card">
              ...
              <div className="product-sales-metric-card__body">
                ...
                <em>
                  درصد وصول:{" "}
                  {creditCollectionRate.toLocaleString("fa-IR", {
                    maximumFractionDigits: 1,
                  })}
                  ٪
                </em>
            ...
            <article className="product-sales-metric-card">
              ...
              <div className="product-sales-metric-card__body">
                ...
                <em>
                  درصد وصول:{" "}
                  {installmentCollectionRate.toLocaleString("fa-IR", {
                    maximumFractionDigits: 1,
                  })}
                  ٪
                </em>
          ...
          <div className="product-sales-metrics-grid product-sales-metrics-grid--secondary">
            ...
            <article className="product-sales-metric-card is-compact">
              ...
              <div className="product-sales-metric-card__body">
                ...
                <small>
                  درصد وصول:{" "}
                  {filteredCollectionRate.toLocaleString("fa-IR", {
                    maximumFractionDigits: 1,
                  })}
                  ٪
                </small>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      ...
                      {Number(p.productId || 0).toLocaleString("fa-IR")} •
                      تعداد: {Number(p.qty || 0).toLocaleString("fa-IR")}
                    </div>
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    <div className="product-sales-table-title">
                      <i className="fa-solid fa-receipt" aria-hidden="true" />
                      <span>جزئیات فروش</span>
                    </div>
                    {auditOnly && (
                      <span className="rounded-full border border-indigo-200 bg-indigo-50 px-2.5 py-1 text-[11px] font-black text-indigo-700 dark:border-indigo-900/60 dark:bg-indigo-950/30 dark:text-indigo-200">
                        {getAuditModeTitle(auditMode)}
                      </span>
                    )}
                  </div>
                  <div className="mt-1 flex flex-wrap items-center gap-2 text-xs font-bold text-gray-500 dark:text-gray-400">
                    <span>
                      {totalFilteredRows.toLocaleString("fa-IR")} ردیف فیلترشده
                    </span>
                    <span className="hidden text-slate-300 dark:text-slate-700 sm:inline">
                      •
                    </span>
                    <span>
                      نمایش {detailStartRow.toLocaleString("fa-IR")} تا{" "}
                      {detailEndRow.toLocaleString("fa-IR")}
                    </span>
                    <span className="hidden text-slate-300 dark:text-slate-700 sm:inline">
                      •
                    </span>
                ...
                <div className="product-sales-table-tools">
                  ...
                  <label
                    className="product-sales-page-size-control"
                    aria-label="تعداد ردیف در صفحه"
                  >
                    <span className="product-sales-page-size-control__label">
                      تعداد در صفحه
                    </span>
                      ...
                      >
                        <td>
                          <div className="product-sales-table-main">
                            ...
                            <span>
                              شناسه سند:{" "}
                              {Number(r.orderId || 0).toLocaleString("fa-IR")}
                            </span>
                          </div>
                        </td>
                        <td>
                          ...
                          >
                            ...
                            <span>
                              ...
                              <small>
                                ...
                                کد{" "}
                                {Number(r.productId || 0).toLocaleString(
                                  "fa-IR",
                                )}{" "}
                                • تعداد{" "}
            ...
            {detailsTotalPages > 1 && (
              <div className="flex flex-col gap-3 border-t border-black/10 px-4 py-3 dark:border-white/10 sm:flex-row sm:items-center sm:justify-between">
                <div className="text-xs font-bold text-slate-500 dark:text-slate-400">
                  نمایش {detailStartRow.toLocaleString("fa-IR")} تا{" "}
                  {detailEndRow.toLocaleString("fa-IR")} از{" "}
                  {totalFilteredRows.toLocaleString("fa-IR")} ردیف
                </div>
                <div className="flex flex-wrap items-center gap-1.5">
                  ...
                  <span className="grid h-9 min-w-[7rem] place-items-center rounded-xl bg-slate-100 px-3 text-xs font-black text-slate-700 dark:bg-slate-900 dark:text-slate-200">
                    {safeDetailsPage.toLocaleString("fa-IR")} /{" "}
                    {detailsTotalPages.toLocaleString("fa-IR")}
                  </span>
                  <button
                    type="button"
                    onClick={() =>
                      setDetailsPage((page) =>
                        Math.min(detailsTotalPages, page + 1),
                      )
                    }
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            <div className="rounded-2xl border border-rose-200 bg-rose-50 px-3 py-3 dark:border-rose-900/60 dark:bg-rose-950/25">
              ...
              <div className="mt-1 text-base font-black text-rose-700 dark:text-rose-100">
                {collectionRisk.counts.critical.toLocaleString("fa-IR")}
              </div>
            </div>
            <div className="rounded-2xl border border-orange-200 bg-orange-50 px-3 py-3 dark:border-orange-900/60 dark:bg-orange-950/25">
              ...
              <div className="mt-1 text-base font-black text-orange-700 dark:text-orange-100">
                {collectionRisk.counts.urgent.toLocaleString("fa-IR")}
              </div>
            </div>
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-3 py-3 dark:border-amber-900/60 dark:bg-amber-950/25">
              ...
              <div className="mt-1 text-base font-black text-amber-700 dark:text-amber-100">
                {collectionRisk.counts.followup.toLocaleString("fa-IR")}
              </div>
            </div>
            <div className="rounded-2xl border border-sky-200 bg-sky-50 px-3 py-3 dark:border-sky-900/60 dark:bg-sky-950/25">
              ...
              <div className="mt-1 text-base font-black text-sky-700 dark:text-sky-100">
                {collectionRisk.counts.low.toLocaleString("fa-IR")}
              </div>
            </div>
          </div>
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <span className="rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 text-[11px] font-black text-slate-600 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-300">
                            {item.sourceType === "installment"
                              ? "اقساطی"
                              : "فاکتور"}{" "}
                            #{item.orderId.toLocaleString("fa-IR")}
                          </span>
                          <span className="rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 text-[11px] font-black text-slate-600 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-300">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 px-3 py-3 dark:border-slate-800 dark:bg-slate-900/50">
              ...
              <div className="mt-1 text-base font-black text-slate-950 dark:text-slate-50">
                {calculationHealth.checkedDocs.toLocaleString("fa-IR")}
              </div>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-slate-50 px-3 py-3 dark:border-slate-800 dark:bg-slate-900/50">
              <div className="text-[10px] font-black text-slate-500 dark:text-slate-400">
              ...
              <div className="mt-1 text-base font-black text-slate-950 dark:text-slate-50">
                {calculationHealth.checkedRows.toLocaleString("fa-IR")}
              </div>
            </div>
            <div className="rounded-2xl border border-rose-200 bg-rose-50 px-3 py-3 dark:border-rose-900/60 dark:bg-rose-950/25">
              <div className="text-[10px] font-black text-rose-600 dark:text-rose-200">
              ...
              <div className="mt-1 text-base font-black text-rose-700 dark:text-rose-100">
                {calculationHealth.errorCount.toLocaleString("fa-IR")}
              </div>
            </div>
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-3 py-3 dark:border-amber-900/60 dark:bg-amber-950/25">
              <div className="text-[10px] font-black text-amber-600 dark:text-amber-200">
              ...
              <div className="mt-1 text-base font-black text-amber-700 dark:text-amber-100">
                {calculationHealth.warningCount.toLocaleString("fa-IR")}
              </div>
            </div>
          </div>
                  ...
                  >
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <span className="rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 text-[11px] font-black text-slate-600 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-300">
                            {issue.sourceType === "installment"
                              ? "اقساطی"
                              : "فاکتور"}{" "}
                            #{issue.orderId.toLocaleString("fa-IR")}
                          </span>
                        </div>
                        <div className="mt-3 text-sm font-black text-slate-950 dark:text-slate-50">
                          {issue.title}
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-2 text-[11px] font-bold text-slate-600 dark:text-slate-300 sm:grid-cols-4">
                      ...
                      <div className="rounded-2xl bg-slate-50 px-3 py-2 dark:bg-slate-950/60">
                        ...
                        <div className="mt-1 font-black">
                          {Number(issue.rowsCount || 0).toLocaleString("fa-IR")}
                        </div>
                      </div>
                    </div>
            ...
            <div className="flex-1 overflow-auto p-5">
              <div className="rounded-[24px] border border-slate-200 bg-slate-50/70 p-4 dark:border-slate-800 dark:bg-slate-900/40">
                ...
                <div className="mt-3 flex flex-wrap gap-2 text-[11px] font-bold text-slate-500 dark:text-slate-400">
                  <span className="rounded-full border border-slate-200 bg-white px-3 py-1 dark:border-slate-700 dark:bg-slate-950">
                    سند #
                    {Number(calculationRow!.orderId || 0).toLocaleString(
                      "fa-IR",
                    )}
                  </span>
                  <span className="rounded-full border border-slate-200 bg-white px-3 py-1 dark:border-slate-700 dark:bg-slate-950">
                  ...
                  <span className="rounded-full border border-slate-200 bg-white px-3 py-1 dark:border-slate-700 dark:bg-slate-950">
                    تعداد {Number(b.quantity || 0).toLocaleString("fa-IR")}
                  </span>
                </div>
              </div>
              ...
              <div className="mt-4 rounded-[24px] border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900/60">
                ...
                <div className="mt-2 text-[11px] font-bold text-slate-500 dark:text-slate-400">
                  درصد وصول:{" "}
                  {b.collectionRate.toLocaleString("fa-IR", {
                    maximumFractionDigits: 1,
                  })}
                  ٪
                </div>
