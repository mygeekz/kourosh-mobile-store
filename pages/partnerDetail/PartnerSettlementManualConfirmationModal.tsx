...
const PartnerSettlementManualConfirmationModal: React.FC<Props> = ({ ctx }) => {
  ...
  return (
    ...
    >
      <div className="space-y-4" data-partner-settlement-manual-confirmation-modal="true">
        <div className="rounded-2xl border border-slate-200 bg-slate-50/80 p-4 dark:border-slate-800 dark:bg-slate-900/60">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-black text-slate-600 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300">
            ...
            <div className={`inline-flex min-h-11 items-center gap-2 rounded-2xl border px-4 text-sm font-black shadow-sm ${toneClass[manualConfirmation.tone] || toneClass.neutral}`}>
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
          <article className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-950/70">
            <div className="text-sm font-black text-slate-800 dark:text-slate-100">مبلغ قابل بازبینی</div>
          ...
          <article className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-950/70">
            <div className="text-sm font-black text-slate-800 dark:text-slate-100">ردیف‌های تایید دستی</div>
          ...
          <article className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-950/70">
            <div className="text-sm font-black text-slate-800 dark:text-slate-100">نقش مجاز</div>
        ...
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
          <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-950/70">
            ...
            <div className="mt-4 max-h-96 space-y-2 overflow-y-auto pe-1">
              {manualConfirmation.confirmationLines.length === 0 ? (
                ...
                <article key={line.id || line.label} className="rounded-2xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-900/60">
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <div className="text-end sm:min-w-40">
                  ...
                  <div className="mt-3 grid grid-cols-1 gap-2 text-xs font-bold text-slate-600 dark:text-slate-300 sm:grid-cols-3">
              ...
              <div className="mt-3 space-y-2">
                {manualConfirmation.safeguards.map((item: string) => (
                  <div key={item} className="rounded-2xl border border-slate-200 bg-slate-50 p-3 text-xs font-semibold leading-6 text-slate-600 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300">
                    <i className="fa-solid fa-shield-halved me-1 text-slate-400" />
                    {item}
                  </div>
                ))}
              </div>
