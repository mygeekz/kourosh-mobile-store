      ...
      <div className="mt-5 grid grid-cols-1 gap-4 xl:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        <div className="rounded-[24px] border border-emerald-200 bg-white p-4 dark:border-emerald-900/40 dark:bg-slate-950/70">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <Button type="button" onClick={focusReconciledBatch} disabled={!idempotencyKey} variant="secondary" size="sm" data-partner-settlement-post-submit-ledger-focus="true" leftIcon={<i className="fa-solid fa-arrow-down-long" />}>نمایش batch در دفتر</Button>
          </div>
          <div className="mt-4 space-y-2">
            {[
              { label: 'ردیف‌های ثبت‌شده در دفتر مالی پیدا شدند.', ok: expectedLedgerMatched },
