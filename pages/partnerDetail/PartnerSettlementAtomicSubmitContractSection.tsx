        ...
        <div className="rounded-[24px] border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-950/70">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-xs font-semibold leading-6 text-slate-500 dark:text-slate-400">پیش از ثبت نهایی تسویه، این شرط‌ها باید جداگانه کنترل شوند.</p>
            </div>
          ...
          <Button type="button" disabled variant="neutral" size="sm" className="mt-3 w-full" data-partner-settlement-atomic-submit-disabled="true" leftIcon={<i className="fa-solid fa-ban" />}>اجرای اتمیک هنوز فعال نیست</Button>
        </div>
