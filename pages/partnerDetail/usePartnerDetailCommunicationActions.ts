...
export function usePartnerDetailCommunicationActions({
  ...
  const scrollToLedger = () => scrollToAppSection(
    document.querySelector<HTMLElement>('[data-ui-people-detail-ledger="partner-standard-v282"]')
      || document.getElementById('partner-ledger-section'),
  );
  const scrollToHistory = () => scrollToAppSection(document.getElementById('partner-purchase-history-section'));
