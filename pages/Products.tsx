...
import { ActionLink, AppSearchField, EmptyState, FormGrid, ManagementDirectoryHero, ManagementDirectoryPagination, ManagementFilterSurface, ManagementKpiGrid, ManagementListSurface, ModalField, PageKit, nonNegativeNumberError, positiveNumberError, requiredSelectionError, requiredTextError, Table } from '@/components/ui';
...
const Products: React.FC = () => {
  ...
  const handleProductFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const guardedPayload = confirmationToken ? { ...payload, confirmationToken } : payload;
      await runWithFeedback(
        apiFetch(url, { method, body: JSON.stringify(guardedPayload) }).then((response) =>
    ...
    >
      <div className="mx-auto w-full max-w-7xl space-y-3 px-3 text-right sm:px-4" dir="rtl" data-ui-management-directory="products" data-ui-products-directory="true">
        ...
        >
          ...
          <div data-ui-adaptive-table-cards="true">
            ...
            <DataTableShell id="products-print-area" dir="rtl" data-ui-adaptive-view="table" data-ui-inventory-table-parity="installments-v322" data-ui-inventory-edge-fix="v323" data-ui-product-action-edge-fix="v324" data-ui-inventory-table-kind="products">
              <Table className="product-list-table" layout="managed" density="comfortable">
                <thead>
            ...
            <div className="space-y-4 p-1 sm:p-2" data-ui-adaptive-view="cards">
              ...
              <ManagementDirectoryPagination
                ...
                ariaLabel="صفحه‌بندی کالاها"
                pageSizeAriaLabel="تعداد نمایش کالا در هر صفحه"
      ...
      <div id="products-print-report-area" className="hidden" aria-hidden="true">
        <section className="product-print-report" dir="rtl">
          ...
          <table data-ui-table="print" className="product-print-report__table">
            <thead>
              <tr>
      ...
      <InventoryModal
        ...
        title={modalMode === 'add' ? 'ثبت اطلاعات محصول جدید در انبار' : `ویرایش اطلاعات محصول: ${editingProduct.name}`}
        onClose={closeProductModal}
        widthClassName="max-w-5xl"
        iconClassName={modalMode === 'add' ? 'fa-solid fa-cube' : 'fa-solid fa-pen-to-square'}
        eyebrow="کالا و انبار"
        panelClassName="product-editor-modal-v325"
        bodyClassName="product-editor-modal-body-v325"
        variant="operational"
        layout="vertical"
      >
        <form
          ...
          className="product-modal-apple product-modal-apple--compact-v325 product-modal-apple--compact-v326 product-modal-apple--compact-v327 space-y-3"
          data-ui-product-editor-density="v325"
          data-ui-product-editor-polish="v326"
          data-ui-product-editor-layout="v327"
          data-ui-product-editor-select-polish="v328"
          data-ui-product-editor-select-runtime="v329"
        >
          <div className="product-modal-apple-shell space-y-3">
            <div className="product-modal-apple-hero product-modal-apple-hero--compact-v326">
              <div className="product-modal-apple-hero__top product-modal-apple-hero__top--compact-v326">
                <div className="product-modal-apple-badge product-modal-apple-badge--v326">
            ...
            <div className="product-modal-apple-grid">
              <section className="product-modal-apple-section product-modal-apple-section--base">
                ...
                <div className="product-modal-apple-fields">
                  <ModalField label="نام محصول" iconClass="fa-solid fa-box" required error={formErrors.name}>
                    <TextField controlSize="sm" type="text" name="name" value={modalMode === 'add' ? newProduct.name : (editingProduct.name as string) || ''} onChange={handleProductFormChange} preview="مثلاً کابل شارژر اصلی آیفون" />
                  </ModalField>

                  <FormGrid columns={2} className="product-modal-apple-inline-grid">
                    <ModalField label="تعداد موجودی" iconClass="fa-solid fa-cubes" error={formErrors.stock_quantity} hint="موجودی اولیه یا فعلی انبار.">
                      <TextField
                        controlSize="sm"
                        type="number"
                        valueKind="number"
                  ...
                  <div className="product-modal-apple-note">
                    ...
                    <span>نام استاندارد، جستجو و گزارش‌گیری را دقیق‌تر می‌کند.</span>
                  </div>
                </div>
              </section>
              ...
              <section className="product-modal-apple-section product-modal-apple-section--finance">
                ...
                <div className="product-modal-apple-fields">
                  ...
                  <ModalField className="product-modal-apple-field--category product-modal-apple-field--searchable-v326" label="دسته‌بندی" iconClass="fa-solid fa-layer-group" error={formErrors.categoryId}>
                    <SearchableSelectField<string>
                      size="sm"
                      controlClassName="product-editor-searchable-control-v326"
                      menuClassName="product-editor-searchable-menu-v329"
                      clearable={false}
                      name="categoryId"
                  ...
                  <ModalField className="product-modal-apple-field--supplier product-modal-apple-field--searchable-v326" label="تأمین‌کننده" iconClass="fa-solid fa-truck" error={formErrors.supplierId} hint="برای قیمت خرید، تأمین‌کننده را انتخاب کن.">
                    <SearchableSelectField<string>
                      size="sm"
                      controlClassName="product-editor-searchable-control-v326"
                      menuClassName="product-editor-searchable-menu-v329"
        ...
        <div className="space-y-4">
          ...
          {activeMgmtTab === 'categories' ? (
            <section id="product-management-categories" className="space-y-4" role="tabpanel">
              ...
              <form noValidate onSubmit={handleCategorySubmit} className="grid min-w-0 gap-3 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-end">
                <ModalField className="min-w-0" label="نام دسته‌بندی" iconClass="fa-solid fa-folder-tree" required error={categoryFormError}>
                  <TextField value={newCategoryName} onChange={(e) => { setNewCategoryName(e.target.value); if (categoryFormError) setCategoryFormError(null); }} preview="مثلاً لوازم جانبی" />
                </ModalField>
              ...
              <DataTableShell aria-label="جدول مدیریت دسته‌بندی‌های کالا">
                <Table className="w-full min-w-[520px]" density="compact">
                  <thead>
                    <tr>
                    ...
                    {categories.map((c, idx) => {
                      ...
                      return (
                        <tr key={c.id}>
                          ...
                          <td>
                            {isEditing ? (
                              <TextField value={editItemName} onChange={(e) => setEditItemName(e.target.value)} />
                            ) : (
            ...
            <section id="product-management-suppliers" className="space-y-4" role="tabpanel">
              ...
              <form noValidate onSubmit={handleSupplierSubmit} className="grid min-w-0 gap-3 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-end">
                <ModalField className="min-w-0" label="نام تأمین‌کننده" iconClass="fa-solid fa-truck" required error={supplierFormError}>
                  <TextField value={newSupplierName} onChange={(e) => { setNewSupplierName(e.target.value); if (supplierFormError) setSupplierFormError(null); }} preview="مثلاً مغازه یا همکار تأمین‌کننده" />
                </ModalField>
      ...
      <InventoryModal
        ...
        title={deletingItem
          ? deletingItem.type === 'product'
            ? 'تایید حذف کالای انبار'
            : deletingItem.type === 'category'
              ? 'تایید حذف دسته‌بندی انبار'
              : 'تایید حذف تأمین‌کننده'
          : 'تایید حذف مورد'}
      ...
      >
        ...
        <ModalActions
          ...
          helperText="پس از تأیید، حذف بلافاصله ثبت می‌شود و برای بازیابی باید مورد را دوباره ثبت کنید."
          hideHelper={false}
          className="pt-1"
        />
      </InventoryModal>
