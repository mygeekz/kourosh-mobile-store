    ...
    <article id="report-print-root" className="installment-contract report-print-shell" dir="rtl" lang="fa">
      ...
      <section className="contract-article">
        ...
        <div className="contract-table-wrap">
          <table data-ui-table="print" className="contract-table" aria-label="مشخصات کالای موضوع قرارداد">
            <colgroup>
              <col style={{ width: '7%' }} />
              <col style={{ width: '17%' }} />
              <col style={{ width: '34%' }} />
      ...
      <section className="contract-article">
        ...
        {payments.length > 0 ? (
          <>
            ...
            <div className="contract-table-wrap">
              <table data-ui-table="print" className="contract-table" aria-label="برنامه اقساط قرارداد">
                <colgroup>
                  <col style={{ width: '12%' }} />
                  <col style={{ width: '44%' }} />
                  <col style={{ width: '44%' }} />
        ...
        {contractMode.hasChecks ? (
          <>
            ...
            <div className="contract-table-wrap">
              <table data-ui-table="print" className="contract-table" aria-label="مشخصات چک‌های قرارداد">
                <colgroup>
                  <col style={{ width: '7%' }} />
                  <col style={{ width: '23%' }} />
                  <col style={{ width: '29%' }} />
