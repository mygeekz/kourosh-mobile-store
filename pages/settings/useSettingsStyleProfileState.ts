...
const sanitizeSnapshot = (style: StyleState, snapshot: Partial<StyleState>): Partial<StyleState> => {
  ...
  if (isStandardStylePalette(sanitized.palette)) {
    ...
    if (sanitized.buttonPressHue === undefined) sanitized.buttonPressHue = palette.buttonPress.hue;
    if (sanitized.buttonPressS === undefined) sanitized.buttonPressS = palette.buttonPress.saturation;
    if (sanitized.buttonPressL === undefined) sanitized.buttonPressL = palette.buttonPress.lightness;
    if (sanitized.buttonActiveHue === undefined) sanitized.buttonActiveHue = palette.buttonActive.hue;
    if (sanitized.buttonActiveS === undefined) sanitized.buttonActiveS = palette.buttonActive.saturation;
    if (sanitized.buttonActiveL === undefined) sanitized.buttonActiveL = palette.buttonActive.lightness;
  }
