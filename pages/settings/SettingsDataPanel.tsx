      ...
      <section className="settings-data-v2-hero" data-ui-settings-data-hero="true">
        <div className="settings-data-v2-hero__main">
          ...
          <div className="min-w-0">
            ...
            <p>تهیه نسخه پشتیبان، زمان‌بندی خودکار، بررسی سلامت فایل و بازیابی کنترل‌شده از همین بخش انجام می‌شود.</p>
          </div>
        </div>
        ...
        <div className="settings-data-v2-schedule-grid" data-ui-settings-grid="form">
          ...
          <aside className="settings-data-v2-preview">
            ...
            <div className={`settings-data-v2-preview__note ${backupFeedbackTone}`}>
              ...
              نسخه پشتیبان به‌صورت کامل تهیه می‌شود تا آخرین تغییرات ثبت‌شده نیز در فایل پشتیبان قرار بگیرند.
            </div>
          </aside>
        </div>
      </section>
      ...
      <section className="settings-data-v2-list" data-ui-settings-data-list="true">
        ...
        {isLoadingBackups ? (
          ...
          <div className="settings-data-v2-empty">
            ...
            <div><strong>نسخه پشتیبانی ثبت نشده است</strong><small>اولین نسخه پشتیبان را بساز تا دانلود و بازیابی در دسترس قرار گیرد.</small></div>
                ...
                <article key={backup.fileName} className="settings-data-v2-backup-row">
                  <div className="settings-data-v2-backup-row__identity">
                    ...
                    <div className="min-w-0">
                      ...
                      <small className="mt-1 block font-mono" dir="ltr"><i className={`fa-solid ${backup.checksumVerified ? 'fa-shield-check' : 'fa-triangle-exclamation'}`} /> SHA256: {backup.sha256 ? `${backup.sha256.slice(0, 16)}…${backup.sha256.slice(-8)}` : 'ناموجود'} · {backup.checksumVerified ? 'verified' : 'unverified'}</small>
                    </div>
                  </div>
      ...
      <section className="settings-data-v2-restore" data-ui-settings-data-restore="true">
        <div className="settings-data-v2-restore__copy">
          ...
          <div>
            ...
            <p>فقط فایل معتبر پشتیبان با پسوند DB پذیرفته می‌شود. سامانه پیش از جایگزینی، سلامت فایل را بررسی و از وضعیت فعلی یک نسخه ایمنی تهیه می‌کند.</p>
          </div>
        </div>
