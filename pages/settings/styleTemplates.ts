...
export const APP_STYLE_TEMPLATES: AppStyleTemplate[] = [
  {
    ...
    snapshot: { palette: 'aurora', theme: 'system', brandMode: 'custom', primaryHue: aurora.hue, primaryS: aurora.saturation, primaryL: aurora.lightness, sidebarIconPx: 28, sidebarPillWidthPx: 272, showInkBar: true, buttonPreset: aurora.buttonPreset, buttonPressHue: aurora.buttonPress.hue, buttonPressS: aurora.buttonPress.saturation, buttonPressL: aurora.buttonPress.lightness, buttonActiveHue: aurora.buttonActive.hue, buttonActiveS: aurora.buttonActive.saturation, buttonActiveL: aurora.buttonActive.lightness, buttonRadiusPx: 18, buttonShadow: 'medium', buttonMotion: 'balanced', uiDensity: 'compact', financeTableDensity: 'compact', controlRadiusPx: 16, cardRadiusPx: 22, reducedMotion: false, highContrast: false },
  },
  {
    key: 'classic-ios',
    label: 'کلاسیک iOS',
  ...
  },
  {
    ...
    snapshot: { palette: 'ocean', theme: 'system', brandMode: 'custom', primaryHue: ocean.hue, primaryS: ocean.saturation, primaryL: ocean.lightness, sidebarIconPx: 30, sidebarPillWidthPx: 280, showInkBar: true, buttonPreset: ocean.buttonPreset, buttonPressHue: ocean.buttonPress.hue, buttonPressS: ocean.buttonPress.saturation, buttonPressL: ocean.buttonPress.lightness, buttonActiveHue: ocean.buttonActive.hue, buttonActiveS: ocean.buttonActive.saturation, buttonActiveL: ocean.buttonActive.lightness, buttonRadiusPx: 18, buttonShadow: 'medium', buttonMotion: 'balanced', uiDensity: 'comfortable', financeTableDensity: 'comfortable', controlRadiusPx: 18, cardRadiusPx: 24, reducedMotion: false, highContrast: false },
  },
  {
    key: 'sunset-sales',
    label: 'فروش پرانرژی',
    ...
    snapshot: { palette: 'sunset', theme: 'system', brandMode: 'custom', primaryHue: sunset.hue, primaryS: sunset.saturation, primaryL: sunset.lightness, sidebarIconPx: 28, sidebarPillWidthPx: 272, showInkBar: true, buttonPreset: sunset.buttonPreset, buttonPressHue: sunset.buttonPress.hue, buttonPressS: sunset.buttonPress.saturation, buttonPressL: sunset.buttonPress.lightness, buttonActiveHue: sunset.buttonActive.hue, buttonActiveS: sunset.buttonActive.saturation, buttonActiveL: sunset.buttonActive.lightness, buttonRadiusPx: 18, buttonShadow: 'medium', buttonMotion: 'balanced', uiDensity: 'compact', financeTableDensity: 'compact', controlRadiusPx: 16, cardRadiusPx: 22, reducedMotion: false, highContrast: false },
  },
  {
    key: 'midnight-pro',
    label: 'شب حرفه‌ای',
    ...
    snapshot: { palette: 'midnight', theme: 'dark', brandMode: 'custom', primaryHue: midnight.hue, primaryS: midnight.saturation, primaryL: midnight.lightness, sidebarIconPx: 28, sidebarPillWidthPx: 272, showInkBar: false, buttonPreset: midnight.buttonPreset, buttonPressHue: midnight.buttonPress.hue, buttonPressS: midnight.buttonPress.saturation, buttonPressL: midnight.buttonPress.lightness, buttonActiveHue: midnight.buttonActive.hue, buttonActiveS: midnight.buttonActive.saturation, buttonActiveL: midnight.buttonActive.lightness, buttonRadiusPx: 16, buttonShadow: 'soft', buttonMotion: 'calm', uiDensity: 'compact', financeTableDensity: 'compact', controlRadiusPx: 16, cardRadiusPx: 22, reducedMotion: true, highContrast: true },
  },
  {
    key: 'matte-gold',
    label: 'طلایی مات',
    ...
    snapshot: { palette: 'gold', theme: 'dark', brandMode: 'custom', primaryHue: gold.hue, primaryS: gold.saturation, primaryL: gold.lightness, sidebarIconPx: 28, sidebarPillWidthPx: 272, showInkBar: true, buttonPreset: gold.buttonPreset, buttonPressHue: gold.buttonPress.hue, buttonPressS: gold.buttonPress.saturation, buttonPressL: gold.buttonPress.lightness, buttonActiveHue: gold.buttonActive.hue, buttonActiveS: gold.buttonActive.saturation, buttonActiveL: gold.buttonActive.lightness, buttonRadiusPx: 18, buttonShadow: 'soft', buttonMotion: 'calm', uiDensity: 'compact', financeTableDensity: 'compact', controlRadiusPx: 16, cardRadiusPx: 22, reducedMotion: false, highContrast: false },
  },
];
