...
const restoreSteps: Array<{ stage: DatabaseRestoreStage; label: string }> = [
  ...
  { stage: 'safety-backup', label: 'ساخت نسخه ایمنی از اطلاعات فعلی' },
      ...
      <div className="settings-data-restore-modal-v2" data-ui-settings-data-restore-modal="v2">
        ...
        {restoreProgress ? (
          <div className="settings-data-restore-modal-v2__file" data-restore-progress-status={restoreProgress.status}>
            ...
            <div>
              <small>مرحله جاری بازیابی · {Math.min(restoreProgress.step, restoreProgress.total).toLocaleString('fa-IR')} از {restoreProgress.total.toLocaleString('fa-IR')}</small>
        ...
        <div className="settings-data-restore-modal-v2__steps" aria-label="مراحل بازیابی اطلاعات">
