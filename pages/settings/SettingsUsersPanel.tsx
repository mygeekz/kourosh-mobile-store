...
import { Table, DataTableShell, SelectField, TableActionGroup, TextField } from '@/components/ui';
...
import SettingsTelegramManagersPanel from './SettingsTelegramManagersPanel';
        ...
        {filteredUsers.length === 0 ? (
          ...
          <>
            <DataTableShell className="settings-users-table-wrap" data-settings-mode="advanced" data-ui-settings-users-table="true">
              <Table layout="managed" density="comfortable" className="settings-table-clean settings-users-table">
                <thead>
                  <tr>
                    <th>کاربر</th>
                    <th>نقش</th>
