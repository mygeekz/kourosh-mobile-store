...
import { FormGrid, SelectField, TextField } from '@/components/ui';
  ...
  return (
    <>
      {isAddUserModalOpen ? (
        ...
        >
          <form noValidate onSubmit={handleNewUserSubmit} className="settings-user-modal-redesign settings-user-modal-redesign-v2 settings-user-modal-redesign--create">
            ...
            <FormGrid columns={2} className="settings-user-modal-grid">
              <TextField
      ...
      {isEditUserModalOpen && editingUser ? (
        <Modal
          ...
          bodyClassName="settings-user-modal-body"
        >
          <form noValidate onSubmit={handleEditUserSubmit} className="settings-user-modal-redesign settings-user-modal-redesign-v2 settings-user-modal-redesign--edit">
            ...
            <SelectField
              label="نقش جدید"
              icon={<i className="fa-solid fa-user-gear" />}
              error={typeof editUserFormErrors.roleId === 'string' ? editUserFormErrors.roleId : undefined}
              wrapperClassName="settings-user-modal-field"
              name="roleId"
      ...
      {isResetPasswordModalOpen && resettingUser ? (
        <Modal
          ...
          bodyClassName="settings-user-modal-body"
        >
          <form noValidate onSubmit={handleResetPasswordSubmit} className="settings-user-modal-redesign settings-user-modal-redesign-v2 settings-user-modal-redesign--reset">
            <div className="settings-user-modal-user">
            ...
            <FormGrid columns={1} className="settings-user-modal-grid settings-user-modal-grid--single">
              <TextField
                ...
                onChange={(event) => { setResetPasswordData((previous) => ({ ...previous, password: event.target.value })); setResetPasswordErrors((previous) => ({ ...previous, password: undefined })); }}
                autoComplete="new-password"
                minLength={6}
                maxLength={128}
                placeholder="حداقل ۶ کاراکتر"
              ...
              />
              <TextField
                id="settings-reset-confirm-password"
                label="تکرار کلمه عبور"
                icon={<i className="fa-solid fa-shield-halved" />}
                ...
                onChange={(event) => { setResetPasswordData((previous) => ({ ...previous, confirmPassword: event.target.value })); setResetPasswordErrors((previous) => ({ ...previous, confirmPassword: undefined })); }}
                autoComplete="new-password"
                minLength={6}
                maxLength={128}
                placeholder="تکرار رمز جدید"
