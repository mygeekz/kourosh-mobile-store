import { DataTableShell, TextareaField } from '@/components/ui';
    ...
    <div className="services-page services-apple-page products-services-redesign-v1 services-redesign-v1 space-y-3 text-right max-w-7xl mx-auto px-2 sm:px-3" dir="rtl" data-ui-service-page="services" data-ui-service-scope="list">
      ...
      <div className="services-apple-panel app-card p-3 md:p-4" data-ui-service-surface="workspace" data-ui-service-table-shell="true">
        <div className="services-workspace-toolbar" data-ui-service-toolbar="true">
          ...
          <div className="services-workspace-toolbar__controls flex w-full flex-col gap-3 md:w-auto md:flex-row md:items-center">
            ...
            <div className="services-toolbar-actions flex flex-wrap items-center justify-start gap-2">
              {currentUser?.roleName === 'Admin' ? (
                <Button
                  type="button"
                  ...
                  variant="primary"
                  size="sm"
                  className="services-new-button shrink-0"
        ...
        {isLoading ? (
          ...
          <DataTableShell className="services-table-scroll" data-ui-services-table="true">
      ...
      {isModalOpen && (
        <Modal
          ...
          ariaDescription="فرم مدیریت خدمت برای ثبت نام، توضیحات و تعرفه با چیدمان واکنش‌گرا."
        >
          <ServiceEditor
            mode={modalMode}
