...
import { SETTINGS_NAV_ITEMS } from './config/ui/settings-navigation';
...
export const SIDEBAR_ITEMS: NavItem[] = [
  ...
  // ✅ مرکز عملیات — اعلان‌ها، پیام‌رسانی و پایش مدیریتی
  {
    id: 'more',
    name: 'مرکز عملیات',
    icon: 'fa-solid fa-layer-group',
    children: [
      { id: 'notifications', name: 'اعلان‌ها', icon: 'fa-solid fa-bell', path: '/notifications', roles: ['Admin'], featureKey: 'notifications_outbox' },
      { id: 'outbox', name: 'مرکز پیام‌رسانی', icon: 'fa-solid fa-inbox', path: '/outbox', roles: ['Admin'], featureKey: 'notifications_outbox' },
      ...
      { id: 'accounting-reconciliation', name: 'تطبیق حسابداری', icon: 'fa-solid fa-scale-balanced', path: '/accounting-reconciliation', roles: ['Admin','Manager'] },
    ],
  },
  {
    id: 'settings',
...
export const SIDEBAR_ACCENTS: Record<string, SidebarAccent> = {
  ...
  'outbox':            'blue',
  'more':              'indigo',
  'settings-ownership':'emerald',
  'audit-log':         'orange',
  'accounting-reconciliation':'emerald',
  'settings':          'rose',
};
