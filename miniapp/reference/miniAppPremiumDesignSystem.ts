...
export const MINIAPP_PREMIUM = Object.freeze({
  ...
  page: "space-y-4",
  topBar: "sticky top-[var(--miniapp-safe-area-top)] z-30 border-b border-white/60 bg-premium-page/90 backdrop-blur-xl",
  topBarInner: "miniapp-safe-inline mx-auto grid h-14 max-w-[30rem] grid-cols-[2.75rem_1fr_2.75rem] items-center gap-2 px-4",
  ...
  dock: "fixed inset-x-0 bottom-0 z-40 mx-auto max-w-[30rem] rounded-t-[1.65rem] border-x border-t border-white/95 bg-white/[0.96] px-2 pb-[max(0.35rem,var(--miniapp-safe-area-bottom))] pt-1.5 shadow-premium-dock backdrop-blur-2xl",
