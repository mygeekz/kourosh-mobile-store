...
export const MINIAPP_VISUAL_REFERENCE = Object.freeze({
  page: "space-y-6 pb-2",
  topBar: "sticky top-[var(--miniapp-safe-area-top)] z-10 border-b border-border/60 bg-background/90 backdrop-blur-md",
  circularAction: "flex size-12 items-center justify-center rounded-full border border-border/70 bg-card text-foreground shadow-lg shadow-primary/5 transition active:scale-95",
  card: "miniapp-card",
  cardInteractive: "miniapp-card miniapp-interactive",
  softCard: "miniapp-card",
  hero: "miniapp-hero relative overflow-hidden p-5",
  ...
  eyebrow: "text-xs font-extrabold text-primary",
  pageTitle: "m-0 miniapp-heading text-2xl font-bold text-foreground",
  pageSubtitle: "mt-1 text-sm leading-6 text-mutedText",
  sectionTitle: "miniapp-heading m-0 text-lg font-bold text-foreground",
  sectionSubtitle: "mt-1 text-xs leading-5 text-mutedText",
  label: "text-xs font-bold text-mutedText",
  ...
  bottomDock: "fixed inset-x-3 bottom-[max(0.65rem,var(--miniapp-safe-area-bottom))] z-30 mx-auto max-w-xl rounded-[var(--radius-lg)] border border-border/70 bg-card/95 p-1.5 shadow-xl shadow-primary/10 backdrop-blur-md",
  navItem: "flex min-h-12 flex-col items-center justify-center gap-0.5 rounded-[var(--radius-md)] px-1 text-xs font-extrabold no-underline transition",
  ...
  filterChip: "inline-flex min-h-12 items-center justify-center gap-1.5 rounded-full border px-4 text-xs font-extrabold transition active:scale-95",
