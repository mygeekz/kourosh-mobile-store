...
import { MINIAPP_GATEWAY_RUNTIME_VERSION, createMiniAppGateway, resolveGatewayClientIp } from "../../scripts/serve-miniapp-gateway.mjs";
...
try {
  ...
  assert.equal(health.headers["x-kourosh-gateway-version"], MINIAPP_GATEWAY_RUNTIME_VERSION);
