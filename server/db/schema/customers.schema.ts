...
export const createCustomersSchema = async (): Promise<void> => {
  ...
  // v341: do not infer or mutate historical ledger references from description text.
  // Missing/ambiguous source identities are surfaced by reconciliation for human review.
