...
import {
  ...
  createManagerNotificationsSchema,
  createManagementAuditHardeningSchema,
  createManagerScheduledReportsSchema,
...
import { seedAccessControlFoundation } from "../seeds/accessControl.seed";
...
export const initializeDatabaseInternal = async (): Promise<void> => {
  ...
  try {
    ...
    await createAccessControlSchema();
    await createTelegramIdentitySecuritySchema();
    await createManagerNotificationsSchema();
    await createManagerScheduledReportsSchema();
    await createInstallmentsSchema();
    await createInvoicesSchema();
    await createRepairsSchema();
    await createAuditSchema();
    await createManagementAuditHardeningSchema();
  ...
  try {
    ...
    await seedAccessControlFoundation();
