...
import { resetSystemTelegramTransportDiscovery, systemTelegramTransport } from "./SystemTelegramTransport";
...
export const configureTelegramTransportRuntime = (settings: Record<string, unknown>) => {
  ...
  if (mode === "system") resetSystemTelegramTransportDiscovery();
  return mode;
};
...
export const getActiveTelegramTransport = () => {
  ...
  if (mode === "system") return systemTelegramTransport;
