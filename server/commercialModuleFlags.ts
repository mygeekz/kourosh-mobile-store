...
export const COMMERCIAL_MODULE_RULES: CommercialModuleRule[] = [
  ...
  { key: 'advanced_reports', settingKey: 'feature_advanced_reports_enabled', title: 'گزارش‌های پیشرفته', apiPrefixes: ['/api/reports/rfm', '/api/reports/cohort', '/api/reports/inventory-turnover', '/api/reports/dead-stock', '/api/reports/abc', '/api/reports/aging-receivables', '/api/reports/cashflow', '/api/reports/analytics-dashboard', '/api/reports/financial-overview', '/api/reports/sales-profit', '/api/reports/realized-profit', '/api/reports/all-sales-ledger', '/api/reports/product-profit-real', '/api/reports/product-margins', '/api/exports'] },
  ...
  { key: 'local_domain_pwa', settingKey: 'feature_local_domain_pwa_enabled', title: 'دسترسی محلی و PWA', apiPrefixes: ['/api/settings/local-domain'] },
];
