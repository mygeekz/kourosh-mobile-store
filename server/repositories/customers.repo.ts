...
export const customersRepo = {
  ...
  addCustomerLedgerEntry: (customerId: number, payload: any, actor?: AccountingAuditActor | null) =>
    withCustomerDb(() => addCustomerLedgerEntryToRepo(customerId, payload, actor)),

  updateCustomerLedgerEntry: (customerId: number, entryId: number, payload: any, actor?: AccountingAuditActor | null) =>
    withCustomerDb(() =>
  ...
  deleteCustomerLedgerEntry: (customerId: number, entryId: number, actor?: AccountingAuditActor | null) =>
    withCustomerDb(() =>
