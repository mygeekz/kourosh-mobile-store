...
export const REPORT_CENTERS: ReportCenter[] = [
  ...
  },
  {
    ...
    tabs: [
      ...
      { path: '/reports/ml-operator-overview', title: 'پایش داده‌های هوشمند', shortTitle: 'پایش هوشمند', description: 'بررسی وضعیت، سوابق و صحت داده‌های تحلیل هوشمند.', adminManagerOnly: true },
    ],
  },
];
