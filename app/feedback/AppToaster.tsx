...
<Toaster
  ...
  reverseOrder={false}
  gutter={14}
  containerStyle={{ zIndex: 'var(--kourosh-z-toast)', right: 20, bottom: 20, left: 'auto', top: 'auto' }}
  toastOptions={{
    duration: 4200,
...
>
  {(t) => {
    ...
    return (
      <div
        className={`app-toast-surface pointer-events-auto w-[min(92vw,460px)] overflow-hidden rounded-[24px] border shadow-[0_25px_70px_-35px_rgba(15,23,42,0.42)] transition-opacity duration-200 ${ui.wrap} ${t.visible ? 'opacity-100' : 'opacity-0'}`}
