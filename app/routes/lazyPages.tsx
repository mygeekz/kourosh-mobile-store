...
export const InitialSetupPage = React.lazy(() => import('../../pages/InitialSetup'));
...
export const AllSalesLedgerReport = React.lazy(() => import('../../pages/reports/AllSalesLedgerReport'));
...
export const MlOperatorOverviewPage = React.lazy(() => import('../../pages/reports/MlOperatorOverviewPage'));
...
export const AccountingReconciliationCenter = React.lazy(() => import('../../pages/AccountingReconciliationCenter'));
export const AccountingDrilldownPage = React.lazy(() => import('../../pages/AccountingDrilldownPage'));

export const LoadingButtonRuntimeMatrix = React.lazy(() => import('../../pages/qa/LoadingButtonRuntimeMatrix'));
export const DashboardRuntimeVisualMatrix = React.lazy(() => import('../../pages/qa/DashboardRuntimeVisualMatrix'));
export const StyleSettingsRuntimeVisualMatrix = React.lazy(() => import('../../pages/qa/StyleSettingsRuntimeVisualMatrix'));
