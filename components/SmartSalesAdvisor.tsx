  ...
  return (
    ...
    >
      ...
      <Drawer
        ...
        title={selectedInsight?.title || "جزئیات پیشنهاد فروش"}
        kicker="چرا این پیشنهاد؟"
        ariaDescription={selectedInsight?.summary}
        iconClass={selectedInsight?.icon || (selectedInsight ? severityCopy[selectedInsight.severity].icon : "fa-solid fa-lightbulb")}
        tone={selectedInsight?.severity === "critical" ? "danger" : selectedInsight?.severity || "info"}
        size="sm"
        side="inline-end"
        panelClassName="smart-sales-advisor-drawer-panel"
        panelAttributes={{
          "data-smart-sales-severity": selectedInsight?.severity,
          "data-report-drawer-kind": "smart-sales-advisor",
        }}
        footer={selectedInsight?.actionTo ? (
          <Button
            type="button"
            variant="primary"
            size="sm"
            ...
            leftIcon={<i className="fa-solid fa-arrow-left" aria-hidden="true" />}
          >
