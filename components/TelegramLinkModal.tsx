      ...
      <div className="telegram-link-modal-v2">
        <section className="telegram-link-modal-v2__intro">
          <div className="telegram-link-modal-v2__intro-copy">
            ...
            <h3 className="telegram-link-modal-v2__title">{rebind ? 'اتصال مجدد امن تلگرام' : 'اتصال امن تلگرام'} {entityLabel}</h3>
            <p className="telegram-link-modal-v2__subtitle">
              {rebind
                ? `این لینک فقط برای جایگزینی امن حساب تلگرام فعلی ${entityLabel} صادر شده است و اتصال قبلی تا زمان تأیید لینک جدید فعال می‌ماند.`
                : `اتصال امن برای فعال‌سازی دریافت و ارسال پیام در پروفایل این ${entityLabel}.`}
            </p>
          </div>
          ...
          <div className="telegram-link-modal-v2__stat-card">
            ...
            <div className="telegram-link-modal-v2__stat-copy">
              ...
              <strong className={isReady ? 'is-success' : 'is-muted'}>
                {isReady ? (rebind ? 'آماده اتصال مجدد' : 'آماده اتصال') : 'نیازمند بررسی'}
              </strong>
            </div>
          </div>
        ...
        {loading ? (
          <div className="telegram-link-modal-v2__loading">
            ...
            <div className="telegram-link-modal-v2__loading-title">در حال آماده‌سازی لینک {rebind ? 'اتصال مجدد' : 'اتصال'} تلگرام</div>
            <div className="telegram-link-modal-v2__loading-subtitle">لطفاً چند لحظه صبر کنید تا QR و لینک امن {entityLabel} تولید شود.</div>
          </div>
        ) : (
            ...
            <div className="telegram-link-modal-v2__side-column">
              <section className="telegram-link-modal-v2__panel telegram-link-modal-v2__panel--steps">
                ...
                <ol className="telegram-link-modal-v2__steps-list">
                  ...
                  <li>
                    ...
                    <span>{rebind ? 'اتصال قبلی پس از تأیید موفق جایگزین می‌شود' : `اتصال در پرونده ${entityLabel} ثبت می‌شود`}</span>
                  </li>
                </ol>
              </section>
              ...
              <section className="telegram-link-modal-v2__panel telegram-link-modal-v2__panel--notes">
                ...
                <ul className="telegram-link-modal-v2__bullet-list">
                  <li>این لینک فقط برای همین {entityLabel} صادر شده است.</li>
            ...
            <div className="telegram-link-modal-v2__main-column">
              <section className="telegram-link-modal-v2__panel telegram-link-modal-v2__panel--qr">
                ...
                <p className="telegram-link-modal-v2__panel-description">
                  برای {rebind ? 'اتصال مجدد این' : 'اتصال این'} {entityLabel} به تلگرام، کد QR زیر را اسکن کنید یا از لینک مستقیم امن استفاده کنید.
                </p>
        ...
        <footer className="telegram-link-modal-v2__footer">
          ...
          >
            {rebind ? 'ایجاد لینک اتصال مجدد' : 'ایجاد لینک جدید'}
          </Button>
        </footer>
      </div>
    </Modal>
