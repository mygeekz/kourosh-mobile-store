...
function shouldInjectSyntheticIcon(el: HTMLElement, label: string) {
  ...
  if (el.closest('.page-shell-actions, .modal-actions, .settings-action-row, .repair-actions-row, .detail-action-row, .ux-toolbar-actions, .customers-toolbar, .ux-table-shell__actions, .ux-table-row-actions, .inventory-table-row-actions, [data-ui-table-action-group="true"], .installment-card-actions')) return true;
  return false;
}
...
function isActionLikeButton(el: HTMLElement, label: string) {
  ...
  if (el.closest('.ux-table-row-actions, .inventory-table-row-actions, [data-ui-table-action-group="true"], .installment-card-actions, .ux-toolbar-actions, .ux-table-shell__actions, .customers-toolbar')) return true;
