...
import { FontAwesomeIcon, PortalLayer } from '@/components/ui';
...
const HeaderQuickPopover: React.FC<HeaderQuickPopoverProps> = ({
  ...
  <PortalLayer layer="popover" className="app-header-quick-popover-layer" attributes={{ 'data-header-contract': 'v3' }}>
    <div
