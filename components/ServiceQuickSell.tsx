        ...
        {services.map((service) => (
          ...
          >
            <div className="flex min-w-0 items-start gap-3">
              <span className="mt-0.5 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-[18px] bg-slate-100 text-slate-700 transition group-hover:bg-slate-200 dark:bg-slate-900 dark:text-slate-200 dark:group-hover:bg-slate-800">
                <i className="fa-solid fa-bolt text-[12px]" />
              </span>
              <div className="min-w-0 flex-1">
                <div className="text-[13px] font-extrabold leading-5.5 text-slate-900 dark:text-slate-100 whitespace-normal break-words">
                  {service.name}
                </div>
              </div>
            </div>
            <div className="justify-self-end pl-1">
              <span className="inline-flex shrink-0 items-center rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 text-[10px] font-bold text-slate-700 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200">
