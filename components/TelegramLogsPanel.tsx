  ...
  return (
    <section className="tg-logs-apple ops-logs-panel telegram-logs-panel" data-ui-ops-panel="telegram-logs" data-ui-ops-surface="logs" dir="rtl">
      <div className="tg-logs-apple__head">
        <div className="tg-logs-apple__identity">
          ...
          <div>
            ...
            <p>گزارش واقعی سمت سرور با صفحه‌بندی، وضعیت پاسخ و مقصد پیام‌ها.{stats.lastSentAt ? ` آخرین رکورد: ${formatDate(stats.lastSentAt)}` : ''}</p>
          </div>
        </div>
        <Button
          type="button"
      ...
      <div className="tg-logs-apple__stats" aria-label="خلاصه لاگ‌های تلگرام">
        <Surface surface="glass" variant="subtle" scheme="adaptive" className="ops-metric-card rounded-2xl" contentClassName="p-3.5">
      ...
      <Surface surface="glass" variant="subtle" scheme="adaptive" className="ops-filter-panel rounded-[22px]" contentClassName="grid grid-cols-1 gap-3 p-4 lg:grid-cols-[180px_minmax(180px,0.7fr)_minmax(260px,1.3fr)]" data-ui-ops-filters="true">
