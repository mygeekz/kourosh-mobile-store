...
export default function ReportDatePresetChips({ fromDate, toDate, onChange, className, compact = false, includeLast30 = false }: Props) {
  ...
  return (
    <div className={['report-date-presets report-date-presets--modern', compact ? 'report-date-presets--compact' : '', className || ''].filter(Boolean).join(' ')} dir="rtl" aria-label="میانبر بازه زمانی گزارش" data-ui-report-date-presets="true" data-skip-global-buttons="true">
