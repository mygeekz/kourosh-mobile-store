    ...
    <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
      <div className="min-w-0">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-7 text-slate-500 dark:text-slate-400">
          نمای مدیریتی برای بررسی سوابق تحلیل، رسیدها و بسته‌های اطلاعاتی ثبت‌شده؛ بدون تغییر خودکار اطلاعات فروشگاه.
        </p>
        {fetchedAt ? (
    ...
    () => [
      {
        ...
        title: 'خلاصه مقایسه گزینه و مبنا',
        description: 'آخرین اطلاعات ثبت‌شده مقایسه را برای بررسی مدیریتی نمایش می‌دهد.',
      },
      {
        key: 'importReceipts' as const,
        title: 'رسیدهای ورود امن',
        description: 'آخرین رسیدهای ثبت‌شده را همراه وضعیت، کد صحت و شمارش خطا یا هشدار نمایش می‌دهد.',
      },
      {
        key: 'exportPackages' as const,
        title: 'خروجی‌ها و بسته‌های انتشار داخلی',
        description: 'اطلاعات بسته‌های خروجی ثبت‌شده را برای پیگیری و بررسی مدیریتی نمایش می‌دهد.',
      },
      {
        key: 'packageSnapshots' as const,
        title: 'سوابق بسته‌های خروجی',
        description: 'آخرین سوابق بسته‌های ذخیره‌شده و کدهای صحت را برای کنترل سازگاری اطلاعات نمایش می‌دهد.',
      },
      {
        key: 'receiptExports' as const,
        title: 'خروجی رسیدهای ثبت‌شده',
        description: 'سوابق خروجی رسیدها برای بررسی سازگاری اطلاعات و وضعیت بسته‌های ثبت‌شده.',
      },
    ],
    [],
  );
    ...
    <div className="space-y-4" dir="rtl" data-ml-operator-overview-anchor="metadata-only-read-only">
      ...
      {filteredDataPanelConfigs.length > 0 ? (
        ...
        <section className="rounded-[28px] border border-dashed border-slate-300 bg-white p-6 text-center dark:border-slate-700 dark:bg-slate-900/80">
          ...
          <p className="mt-2 text-xs leading-6 text-slate-500 dark:text-slate-400">عبارت جستجو، نوع بخش یا وضعیت را تغییر دهید تا اطلاعات دوباره نمایش داده شوند.</p>
          <button
            type="button"
