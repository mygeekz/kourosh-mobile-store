...
export default function ProfitSignalModal({
  ...
  const headerCopy = mode === 'real_profit'
    ? {
        ...
        reasonsText: 'این دلایل از داده‌های ثبت‌شده همین تحلیل دریافت شده‌اند.',
        routesTitle: 'اقدام پیشنهادی',
        routesText: 'فقط مسیرهای معتبر ثبت‌شده برای این پیشنهاد نمایش داده می‌شوند.',
      }
    : {
        ...
        reasonsText: 'این دلایل از داده‌های ثبت‌شده همین هشدار دریافت شده‌اند.',
  ...
  const sidebarCards: ProfitCardItem[] = [
    { label: 'امتیاز', value: formatExactNumberText(num(selected.score)), icon: 'fa-chart-simple', tone: 'violet' },
  ...
  const memoryCards = [
    ...
    { label: 'دفعات تکرار', value: `${formatExactNumberText(repeatedCount)} بار`, icon: 'fa-rotate', tone: 'amber' },
          ...
          <main className="profit244-main">
              ...
              <section className="profit244-panel">
                ...
                <div className="profit244-reason-list">
                  {reasons.length ? (
                    ...
                    <div className="profit244-empty"><i className="fa-solid fa-database" /> برای این مورد دلیل تکمیلی ثبت نشده است.</div>
                  )}
                </div>
              </section>
            </section>
            ...
            <section className="profit244-panel">
              ...
              <div className="profit244-route-list">
                ...
                )) : <div className="profit244-empty"><i className="fa-solid fa-database" /> مسیر مشخصی برای این پیشنهاد ثبت نشده است.</div>}
              </div>
