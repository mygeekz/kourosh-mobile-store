...
export default function AiSalesAgentModal({
  ...
  const assistantKpis = [
    { label: 'مشتریان آماده اقدام', value: metricMap.get('لید فعال') || formatExactNumberText(leads.length), suffix: 'مشتری', icon: 'fa-user-check', tone: 'emerald' },
    ...
    { label: 'اقدام فوری باز', value: formatExactNumberText(openActions), suffix: 'اقدام', icon: 'fa-circle-exclamation', tone: 'orange' },
      ...
      <section className="agt203-content-grid">
        <article className="agt203-panel agt203-table-panel">
          ...
          <div className="agt203-table">
            ...
            <div className="agt203-table-body">
              ...
              {!leads.length ? <div className="agt203-empty">مشتری آماده اقدام در این تحلیل ثبت نشده است.</div> : null}
            </div>
          </div>
        </article>
        ...
        <article className="agt203-panel agt203-reasons">
          ...
          <div className="agt203-reason-list">
            ...
            {!assistantReasons.length ? <div className="agt203-empty">دلیل تکمیلی برای این پیشنهاد ثبت نشده است.</div> : null}
          </div>
        </article>
      </section>
