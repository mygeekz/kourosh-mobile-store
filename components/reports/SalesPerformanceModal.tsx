...
export default function SalesPerformanceModal({
  ...
  const salesKpis = [
    ...
    { label: 'اعتماد تحلیل', value: percent(selected.confidence), suffix: '', icon: 'fa-shield-halved', tone: 'orange' },
  ];
  ...
  return (
    <SmartInsightModalPortal>
      <div className="sale202-overlay sale202-overlay--sidebar-safe" style={modalStyle} onClick={() => onClose()}>
      ...
      <section className="sale202-content-grid">
        <article className="sale202-panel sale202-table-panel">
          ...
          <div className="sale202-table">
            ...
            <div className="sale202-table-body">
              ...
              {!compareRows.length ? <div className="sale202-empty">شاخص تکمیلی برای این تحلیل ثبت نشده است.</div> : null}
            </div>
          </div>
        </article>
        ...
        <article className="sale202-panel sale202-reasons">
          ...
          <div className="sale202-reason-list">
            ...
            {!salesReasons.length ? <div className="sale202-empty">دلیل تکمیلی برای این تحلیل ثبت نشده است.</div> : null}
          </div>
        </article>
      </section>
