...
function MlWorkbenchImportResultDashboardRoot() {
  ...
  const phase11lPanelSummaries: Array<{
    ...
    {
      key: 'shadowReadiness',
      label: 'آمادگی مدل برای پایش کنترل‌شده',
      description: 'خلاصه آمادگی مدل‌ها برای ورود به مرحله پایش کنترل‌شده.',
    ...
    },
    {
      ...
      label: 'نقشه سازگاری داده‌ها',
      description: 'نمایش بصری سازگاری و اختلاف بین مجموعه‌های اطلاعاتی.',
      metric: `سازگاری: ${nf.format(consistencyHeatmap.summary.consistencyScore)}%`,
      status: 'نمایش صرفاً بصری',
    },
    {
      key: 'offlineMetrics',
      label: 'مقایسه شاخص‌های مدل',
      description: 'مقایسه شاخص‌های ثبت‌شده مدل‌ها برای شناسایی اختلاف‌ها.',
    ...
    {
      key: 'trendRegression',
      label: 'خلاصه روند تغییر شاخص‌ها',
      description: 'نمایش روند تغییر شاخص‌ها و هشدارهای مهم در طول زمان.',
    ...
    },
    {
      ...
      label: 'فضای یادداشت و مرور',
      description: 'یادداشت‌های مرور، جستجو و نماهای ذخیره‌شده برای پیگیری نتایج.',
