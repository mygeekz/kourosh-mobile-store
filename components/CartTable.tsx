...
import { TableActionGroup, TextField } from '@/components/ui';
          ...
          >
            <div className="px-3 py-3 md:px-3.5">
              <div className="flex items-start gap-2.5">
                ...
                <TableActionGroup
                  ariaLabel="عملیات ردیف سبد فروش"
                  collapseBelow="sm"
                  align="end"
                  actions={[
                    {
                      ...
                      icon: <i className={`fa-solid fa-chevron-down transition ${expanded ? 'rotate-180' : ''}`} aria-hidden="true" />,
                      variant: 'secondary',
