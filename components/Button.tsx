...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  ...
  return (
    <button
      ...
      data-ui-color-owner={unstyled ? undefined : resolveActionControlColorOwner(variant)}
      data-ui-interaction-owner={unstyled ? undefined : resolveActionControlColorOwner(variant)}
