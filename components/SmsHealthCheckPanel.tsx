      ...
      <div className="flex flex-col gap-3 border-b border-slate-200 pb-4 dark:border-slate-800 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-0.5 text-[10px] leading-5 text-slate-500 dark:text-slate-400 sm:text-[11px]">این بررسی فقط تنظیمات ذخیره‌شده را ارزیابی می‌کند و بدون ارسال پیامک واقعی انجام می‌شود.</p>
          </div>
        </div>
        <div className="flex flex-wrap items-center gap-2">
