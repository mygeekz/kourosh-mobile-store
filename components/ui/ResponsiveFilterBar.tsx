...
const ResponsiveFilterBar: React.FC<Props> = ({
  ...
  return (
    <div className={cn('responsive-filter-bar ux-filter-bar', className)} dir={dir} data-ui-toolbar-role="filter" data-ui-filter-bar="true" data-ui-contrast-contract="adaptive">
