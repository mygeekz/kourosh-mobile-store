    ...
    <div className="kourosh-modal-actions__buttons app-modal-command-row">
      {onCancel ? (
        <Button
          ...
          className={cn('kourosh-modal-actions__button kourosh-modal-actions__button--cancel modal-btn app-command-button app-command-button--cancel', cancelButtonProps?.className)}
      ...
      <Button
        ...
        className={cn('kourosh-modal-actions__button kourosh-modal-actions__button--submit modal-btn app-command-button app-command-button--submit', submitButtonProps?.className)}
