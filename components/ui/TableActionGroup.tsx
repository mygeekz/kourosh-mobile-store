...
const TableActionGroup: React.FC<TableActionGroupProps> = ({
  ...
  const { position: menuPosition } = useAnchoredOverlayPosition({
    isOpen: open,
    anchorRef: triggerRef,
    panelRef: menuRef,
    preferredWidth: MENU_WIDTH,
    fallbackPanelHeight: Math.max(72, visibleActions.length * 44 + 16),
    maxPanelHeight: 420,
  ...
  return (
    ...
    >
      ...
      <PortalLayer
        isOpen={open && Boolean(menuPosition)}
        layer="popover"
      ...
      >
        <div
          ...
          className="app-floating-surface app-floating-menu-surface pointer-events-auto"
