...
export type ActionControlColorOwner = 'template' | 'semantic';

export const TEMPLATE_BOUND_ACTION_VARIANTS = ['primary', 'secondary', 'ghost', 'neutral'] as const satisfies readonly ActionControlVariant[];
export const SEMANTIC_ACTION_VARIANTS = ['success', 'warning', 'danger'] as const satisfies readonly ActionControlVariant[];

export const isTemplateBoundActionVariant = (variant: ActionControlVariant): boolean =>
  (TEMPLATE_BOUND_ACTION_VARIANTS as readonly ActionControlVariant[]).includes(variant);

export const resolveActionControlColorOwner = (variant: ActionControlVariant): ActionControlColorOwner =>
  isTemplateBoundActionVariant(variant) ? 'template' : 'semantic';
