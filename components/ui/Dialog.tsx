...
import DialogShell, { type DialogMobileBehavior } from './DialogShell';
...
export interface DialogProps {
  ...
  mobileBehavior?: DialogMobileBehavior | 'auto';
...
const Dialog: React.FC<DialogProps> = ({
  ...
  const resolvedMobileBehavior: DialogMobileBehavior = mobileBehavior === 'auto'
    ? resolvedVariant === 'compact'
      ? 'dialog'
      : resolvedVariant === 'expansive'
        ? 'fullscreen'
        : 'sheet'
    : mobileBehavior;
  ...
  return (
    <DialogShell
      ...
      panelAttributes={{
        ...
        'data-modal-mobile': resolvedMobileBehavior,
