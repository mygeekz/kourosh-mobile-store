...
assert(header.includes('<HeaderSearch') && header.includes('{...headerSearch}') && header.includes('onOpenCommandPalette={onOpenCommandPalette}'), 'HeaderSearch should receive the hook contract directly.');
