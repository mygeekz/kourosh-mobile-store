...
assert.equal(
  ...
  'node scripts/generate-style-bootstrap.mjs && node scripts/rebuild-css-entry.mjs && node scripts/audit-style-manifest.mjs && node scripts/audit-tailwind-entry-integrity-v266.mjs',
...
console.log('v266 production style prebuild contract audit passed.');
