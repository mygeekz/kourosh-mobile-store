...
console.log(JSON.stringify({status:'PASS',release:'v264',repairDetailRawFormControls:0,repairDetailInlineStyles:0,repairDetailPageSpecificCssImports:0,sharedPrimitives:true,businessEndpointsPreserved:true},null,2));
