...
for (const file of targetFiles) {
  ...
  totals.SearchableSelectField += (source.match(/<SearchableSelectField\b/g) ?? []).length;
...
assert.ok(totals.SelectField + totals.SearchableSelectField >= 20, `Expected at least 20 canonical select-family consumers; found ${totals.SelectField + totals.SearchableSelectField}.`);
...
console.log(JSON.stringify({
  ...
  canonicalUsages: {
    ...
    searchableSelect: totals.SearchableSelectField,
