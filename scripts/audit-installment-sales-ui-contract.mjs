...
assert.doesNotMatch(listSource, /className=(?:["'][^"']*\binstallment-sales-|\{[^}]*\binstallment-sales-)/, 'InstallmentSalesPage must not restore feature-owned installment-sales-* CSS classes.');
