...
assert.equal(resolveTelegramTransportMode({ telegram_transport_mode: "system" }), "system");
...
configureTelegramTransportRuntime({ telegram_transport_mode: "system" });
assert.equal(getActiveTelegramTransport().mode, "system");
