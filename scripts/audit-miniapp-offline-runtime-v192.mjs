...
assert.match(availabilityViewModel, /source: presentation\?\.source \|\| null/);
assert.match(sharedHeader, /useMiniAppAvailabilityViewModel/);
assert.match(sharedHeader, /availability\.source === "snapshot"/);
assert.match(sharedHeader, /availabilityView\.detail/);
