...
export const RC_IDS = Object.freeze({
  tenantId: "tenant-v257-rc",
  installationId: `inst_${b64u(Buffer.from("v257-release-candidate"))}`.slice(0, 29),
  botId: "123456789",
  publicHost: "miniapp.v257.example",
  liveOrigin: "https://live-miniapp.v257.example",
});
