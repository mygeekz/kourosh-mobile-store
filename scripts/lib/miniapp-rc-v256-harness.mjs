...
export const RC_IDS = Object.freeze({
  tenantId: "tenant-v256-rc",
  installationId: `inst_${b64u(Buffer.from("v256-release-candidate"))}`.slice(0, 29),
  botId: "123456789",
  publicHost: "miniapp.v256.example",
  liveOrigin: "https://live-miniapp.v256.example",
});
