...
export const RC_IDS = Object.freeze({
  tenantId: "tenant-v263-rc",
  installationId: `inst_${b64u(Buffer.from("v263-release-candidate"))}`.slice(0, 29),
  botId: "123456789",
  publicHost: "miniapp.v263.example",
  liveOrigin: "https://live-miniapp.v263.example",
});
