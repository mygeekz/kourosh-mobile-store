...
export const RC_IDS = Object.freeze({
  tenantId: "tenant-v264-rc",
  installationId: `inst_${b64u(Buffer.from("v264-release-candidate"))}`.slice(0, 29),
  botId: "123456789",
  publicHost: "miniapp.v264.example",
  liveOrigin: "https://live-miniapp.v264.example",
});
