...
export const RC_IDS = Object.freeze({
  tenantId: "tenant-v258-rc",
  installationId: `inst_${b64u(Buffer.from("v258-release-candidate"))}`.slice(0, 29),
  botId: "123456789",
  publicHost: "miniapp.v258.example",
  liveOrigin: "https://live-miniapp.v258.example",
});
