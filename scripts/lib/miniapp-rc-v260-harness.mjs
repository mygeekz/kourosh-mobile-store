...
export const RC_IDS = Object.freeze({
  tenantId: "tenant-v260-rc",
  installationId: `inst_${b64u(Buffer.from("v260-release-candidate"))}`.slice(0, 29),
  botId: "123456789",
  publicHost: "miniapp.v260.example",
  liveOrigin: "https://live-miniapp.v260.example",
});
