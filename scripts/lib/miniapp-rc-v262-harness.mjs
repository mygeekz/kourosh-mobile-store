...
export const RC_IDS = Object.freeze({
  tenantId: "tenant-v262-rc",
  installationId: `inst_${b64u(Buffer.from("v262-release-candidate"))}`.slice(0, 29),
  botId: "123456789",
  publicHost: "miniapp.v262.example",
  liveOrigin: "https://live-miniapp.v262.example",
});
