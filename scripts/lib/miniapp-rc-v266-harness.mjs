...
export const RC_IDS = Object.freeze({
  tenantId: "tenant-v266-rc",
  installationId: `inst_${b64u(Buffer.from("v266-release-candidate"))}`.slice(0, 29),
  botId: "123456789",
  publicHost: "miniapp.v266.example",
  liveOrigin: "https://live-miniapp.v266.example",
});
