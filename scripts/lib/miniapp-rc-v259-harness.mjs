...
export const RC_IDS = Object.freeze({
  tenantId: "tenant-v259-rc",
  installationId: `inst_${b64u(Buffer.from("v259-release-candidate"))}`.slice(0, 29),
  botId: "123456789",
  publicHost: "miniapp.v259.example",
  liveOrigin: "https://live-miniapp.v259.example",
});
