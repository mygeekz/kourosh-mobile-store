...
export const RC_IDS = Object.freeze({
  tenantId: "tenant-v265-rc",
  installationId: `inst_${b64u(Buffer.from("v265-release-candidate"))}`.slice(0, 29),
  botId: "123456789",
  publicHost: "miniapp.v265.example",
  liveOrigin: "https://live-miniapp.v265.example",
});
