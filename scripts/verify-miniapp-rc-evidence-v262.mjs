...
const evidencePath = path.resolve(process.env.KOUROSH_MINIAPP_RC_EVIDENCE || "config/quality/miniapp-rc-evidence-v262.json");
if (!fs.existsSync(evidencePath)) {
  console.error(JSON.stringify({
    ...
    template: "config/quality/miniapp-rc-evidence-v262.example.json",
  }, null, 2));
  process.exit(1);
}
