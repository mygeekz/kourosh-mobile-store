...
export const FEATURE_FLAGS: FeatureFlagDefinition[] = [
  ...
  { key: 'local_domain_pwa', title: 'دسترسی محلی و PWA', description: 'تنظیم دامنه داخلی، گواهی محلی و نصب اپ روی دستگاه‌ها.', category: 'system', tier: 'advanced', defaultEnabled: true, optional: true, icon: 'fa-solid fa-network-wired', settingKey: 'feature_local_domain_pwa_enabled' },
];
