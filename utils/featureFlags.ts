...
export const FEATURE_FLAGS: FeatureFlagDefinition[] = [
  ...
  { key: 'sms', title: 'پیامک', description: 'ارسال پیامک قالب‌محور و بررسی قالب‌ها؛ فقط وقتی سرویس پیامک فعال است روشن بماند.', category: 'messaging', tier: 'advanced', defaultEnabled: true, optional: true, icon: 'fa-solid fa-message', settingKey: 'feature_sms_enabled' },
  ...
  { key: 'local_domain_pwa', title: 'دسترسی محلی و نصب برنامه', description: 'تنظیم دامنه داخلی، گواهی محلی و نصب اپ روی دستگاه‌ها.', category: 'system', tier: 'advanced', defaultEnabled: true, optional: true, icon: 'fa-solid fa-network-wired', settingKey: 'feature_local_domain_pwa_enabled' },
];
...
export const MICRO_FEATURE_FLAGS: FeatureFlagDefinition[] = [
  ...
  { key: 'phone_ai_price_signal', title: 'سیگنال هوشمند قیمت در ثبت گوشی', description: 'محاسبه قیمت پیشنهادی، ریسک قیمت و میزان اطمینان پیشنهاد. با خاموش شدن این قابلیت، کارت پیشنهاد هوشمند قیمت در فرم ثبت گوشی نمایش داده نمی‌شود.', category: 'ai', tier: 'enterprise', defaultEnabled: true, optional: true, icon: 'fa-solid fa-signal', scope: 'feature', parentKey: 'ai_pricing', groupTitle: 'ثبت گوشی', order: 20, settingKey: 'feature_phone_ai_price_signal_enabled' },
  ...
  { key: 'phone_pricing_behavior_learning', title: 'یادگیری رفتار قیمت‌گذاری گوشی', description: 'ثبت تصمیم‌های قبول، اصلاح یا ورود دستی قیمت و استفاده از سابقه آن‌ها برای بهبود پیشنهادهای بعدی. با خاموش شدن، یادگیری جدید متوقف می‌شود.', category: 'ai', tier: 'enterprise', defaultEnabled: true, optional: true, icon: 'fa-solid fa-brain', scope: 'feature', parentKey: 'ai_pricing', groupTitle: 'ثبت گوشی', order: 40, settingKey: 'feature_phone_pricing_behavior_learning_enabled' },
  ...
  { key: 'dashboard_clock_widget', title: 'ساعت داشبورد', description: 'نمای ساعت، تاریخ شمسی و وضعیت لحظه‌ای داشبورد. با خاموش شدن، ویجت ساعت از داشبورد حذف می‌شود.', category: 'core', tier: 'commercial', defaultEnabled: true, optional: true, icon: 'fa-solid fa-clock', scope: 'feature', parentKey: 'dashboard_experience', groupTitle: 'داشبورد', order: 70, settingKey: 'feature_dashboard_clock_widget_enabled' },
